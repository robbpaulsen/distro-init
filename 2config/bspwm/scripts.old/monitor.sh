...
ONLY_ONE_MONITOR_NAME="DP-0"   # e.g: Laptop monitor name
MONITOR_ORDER="HDMI-0 DP-0"    # blank to default order, defines the order of the workspaces for the monitors
